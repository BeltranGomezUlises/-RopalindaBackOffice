...
export default class Filter extends React.Component {
    ...
    filter() {
        ...
        let route = "compatibleGarments?select=id,name,price,previewImage,description,active=true";
        if(filter.name !== ''){
            route = "compatibleGarments?select=id,previewImage,price,description,active=true,name%'" + filter.name+"'";
        }
        ...
        return (
            <Segment style={{ 'padding': '10px' }}>
                ...
                <Form onSubmit={this.filter}>
                    <Form.Group>                        
                        <Form.Field>
                            <label>Nombre de prenda compatible:</label>
                            <input type='text'
                ...
                <Modal
                    ...
                    <Header content='Agregar prenda compatible' textAlign='center' />
                    <Modal.Content>
