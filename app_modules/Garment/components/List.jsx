...
export default class List extends React.Component {
    ...
    eliminar() {
        ...
        fetch(localStorage.getItem('url') + 'garments/' + this.state.activeEntity.id, {
            method: 'DELETE',
            headers: {
        ...
        if (this.props.collection.length == 0) {
            return (
                <Segment textAlign='center'>
                    <h3>Sin prendas para mostrar</h3>
                </Segment>
            )
        }
        return (
            <Segment>
                ...
                <Modal
                    ...
                    <Header content='Eliminar compatible' textAlign='center' />
                    <Modal.Content>
                        <h4 align='center'>¿Está seguro de eliminar la prenda?</h4>
                    </Modal.Content>
                    <Modal.Actions>
                ...
                <Modal
                    ...
                    <Header content='Editar prenda' textAlign='center' />
                    <Modal.Content>
