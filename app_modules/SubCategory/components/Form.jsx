...
export default class EntityForm extends React.Component {
    ...
    handleSubmit() {
        ...
        if(element.category.id == null){
            this.setState({warningMessage:'Debe proporcionar una categoría'})
            return;
        }      

        this.setState({ loading: true });
        fetch(localStorage.getItem('url') + 'subcategories', {
            method: 'POST',
            headers: {
            ...
            <div>
                ...
                <Form onSubmit={this.handleSubmit}>
                    <Form.Field control={Input} required label='Nombre:'
                        type='text' placeholder='Nombre de la subcategoría...' maxLength='50'
