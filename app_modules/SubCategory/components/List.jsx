...
export default class List extends React.Component {
    ...
    eliminar() {
        ...
        fetch(localStorage.getItem('url') + 'subcategories/' + this.state.activeEntity.id, {
            method: 'DELETE',
            headers: {
        ...
        if (this.props.collection == null) {
            return (
                <Segment style={{ 'height': '100px' }}>
                    Buscar sub-categorías para mostrar...
                </Segment>
            )
        }
        if (this.props.collection.length == 0) {
            return (
                <Segment textAlign='center'>
                    <h3>Sin sub-categorías para mostrar</h3>
                </Segment>
            )
        }
        return (
            <Segment>
                ...
                <Modal
                    ...
                    <Header content='Eliminar sub-categoría' textAlign='center' />
                    <Modal.Content>
                        <h4 align='center'>¿Está seguro de eliminar la sub-categoría?</h4>
                    </Modal.Content>
                    <Modal.Actions>
